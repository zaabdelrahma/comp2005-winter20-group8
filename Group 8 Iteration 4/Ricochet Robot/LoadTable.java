...
public class LoadTable extends JFrame implements ActionListener, MouseListener{
    ...
    private JButton savegame, exitgame, hint, startclock, resumeclock, pauseclock, up, down, left, right, bids, resetrobotselection, resetmove, instruction, mainmenu;
    ...
    private int paint, targetchip, currentrobot, targettext, savedtime, winner, rounds, xco, yco;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        }else if(click.equals(instruction)){
            showInstructions();
    ...
    public void textswitch(int robotcount, int column, int yrow){
        if (whos_turn.getText().equals("Player 1's turn")) {
            int s = Integer.valueOf(scoreboardtable.getValueAt(1,1).toString());
            scoreboardtable.setValueAt(s+1, 1, 1);
